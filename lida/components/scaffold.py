...
class ChartScaffold(object):
    ...
    def get_template(self, goal: Goal, library: str):
        ...
        if library == "matplotlib":
            ...
            if contains_chinese(goal.question):
                template = \
                f"""
